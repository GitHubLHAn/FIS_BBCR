...
/* Private defines -----------------------------------------------------------*/
#define CTRL_LED_GNSS_Pin GPIO_PIN_13
#define CTRL_LED_GNSS_GPIO_Port GPIOE
#define PUL_N_Pin GPIO_PIN_14
#define PUL_N_GPIO_Port GPIOE
#define CTRL_LED_LTE_Pin GPIO_PIN_15
#define CTRL_LED_LTE_GPIO_Port GPIOE
...
#define CTRL_BRAKE_Pin GPIO_PIN_5
#define CTRL_BRAKE_GPIO_Port GPIOD
